...
import com.example.foodnow.ui.account.AccountViewModel

class RestaurantOwnerProfileFragment : Fragment(R.layout.fragment_profile_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Fetch user profile (restaurant owner's personal info)
        ...
        viewModel.userProfile.observe(viewLifecycleOwner) { result ->
            result.onSuccess { user ->
                ...
                // Phone field might not exist in User model
